      ...
      <form onSubmit={handleSubmit} className="bg-slate-900 border border-white/5 rounded-xl p-8 space-y-6">
        ...
        {!isNew && (
          <div className="border-t border-white/5 pt-6">
            <h3 className="text-lg font-semibold text-white mb-4">Upload Template HTML</h3>
            ...
            <input
              ...
              onChange={async (e) => {
                ...
                try {
                  ...
                  if (res.ok) {
                    setUploadMessage(`✅ Template uploaded successfully! Component: ${data.component}`);
            ...
            >
              {uploading ? (
                <>
                  ...
                  <span className="text-xs text-slate-400">Uploading and converting...</span>
                </>
              ) : !formData.category ? (
                <>
                  ...
                  <span className="text-xs text-slate-400">Please select a category first</span>
                </>
              ) : (
                <>
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8 text-slate-500 mb-2">
                  ...
                  <span className="text-xs text-slate-400">Click to upload HTML template file</span>
                </>
              )}
            </label>
            {uploadMessage && (
