    ...
    fetch('/api/admin/casinos', { credentials: 'include' })
      ...
      if (casino) {
        ...
        setFormData({
          ...
          seoTitle: casino.seoTitle || data.seoTitle || '',
          metaDescription: casino.seoDescription || data.metaDescription || '',
          metaKeywords: Array.isArray(data.metaKeywords) ? data.metaKeywords.join(', ') : (data.metaKeywords || ''),
          seoAuthor: casino.seoAuthor || 'Bonusory Team',
          seoCanonical: casino.seoCanonical || '',
          seoRobots: casino.seoRobots || 'index, follow',
  ...
  const handleSubmit = async (e: React.FormEvent, publish: boolean = false) => {
    ...
    try {
      const casinoDataObj = {
        ...
        seoCanonical: formData.seoCanonical || undefined,
