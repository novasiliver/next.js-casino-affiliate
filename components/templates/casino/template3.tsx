...
interface ReviewTemplate3Props {
  casino: Casino;
}

export default function ReviewTemplate3({ casino }: ReviewTemplate3Props) {
  return (
        ...
        <div className="pt-24 pb-8 border-b border-white/5 bg-slate-950 relative overflow-hidden">
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                  <nav className="flex items-center text-xs text-slate-500 mb-6 gap-2">
                      ...
                      <span className="text-amber-500">Ignite Casino</span>
                  </nav>
                      ...
                      <div className="flex items-center gap-6">
                          ...
                          <div>
                              <div className="flex items-center gap-2 mb-2">
                                  <h1 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">Ignite Casino</h1>
                              ...
                              <div className="flex flex-wrap items-center gap-4 text-sm text-slate-400">
                                  ...
                                  <span>Est. 2021</span>
                                  <span className="w-1 h-1 rounded-full bg-slate-700"></span>
                                  <span className="flex items-center gap-1"><span className="w-3 h-3" data-lucide="globe"></span> Global</span>
                              </div>
                          </div>
                      </div>
                      <div className="w-full lg:w-auto flex flex-col sm:flex-row gap-4">
                          <div className="flex-1 sm:text-right px-4 border-l border-white/10 lg:border-none">
                              ...
                              <p className="text-lg font-bold text-white flex items-center sm:justify-end gap-2">
                                  <span className="w-4 h-4 text-amber-400" data-lucide="zap"></span> Instant
                              </p>
                          </div>
                          ...
                          <div className="rounded-xl border border-white/5 bg-slate-900 p-6">
                              ...
                              <ul className="space-y-3">
                                  ...
                                  <li className="flex justify-between text-sm">
                                      ...
                                      <span className="text-slate-300 flex items-center gap-1">Curacao <span className="w-3 h-3 text-emerald-500" data-lucide="shield-check"></span></span>
                                  </li>
                                  <li className="flex justify-between text-sm">
