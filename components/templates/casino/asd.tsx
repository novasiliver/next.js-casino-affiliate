...
export default function Asd({ casino, previewMode = false }: AsdProps) {
                  ...
                  <div className="flex flex-col lg:flex-row gap-8 items-start lg:items-center justify-between">
                      <div className="flex items-center gap-6">
                          <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-2xl bg-gradient-to-b from-slate-800 to-slate-900 border border-white/10 flex items-center justify-center shrink-0 shadow-2xl">
                              <span className="font-bold text-2xl sm:text-3xl tracking-tighter text-white">{previewMode ? (
                                  ...
                                  <tbody className="divide-y divide-white/5 text-sm text-slate-300">
                                      <tr className="group hover:bg-slate-800/50 transition-colors">
                                          <td className="p-4 flex items-center gap-3">
                                              ...
                                              <span className="font-medium text-white">{previewMode ? (
                                      <span className="font-bold text-2xl sm:text-3xl tracking-tighter text-white">Bitcoin</span>
                                    ) : casino.logo && (casino.logo.startsWith('/') || casino.logo.startsWith('http')) ? (
                                      <Image src={casino.logo} alt={casino.name} width={128} height={128} className="object-contain max-w-full max-h-full"  />
                                    ) : (
                                      <span className="font-bold text-2xl sm:text-3xl tracking-tighter text-white">{getLogoText()}</span>
                                      ...
                                      <tr className="group hover:bg-slate-800/50 transition-colors">
                                          <td className="p-4 flex items-center gap-3">
                                              <div className="w-8 h-8 rounded bg-slate-700 flex items-center justify-center text-white font-bold text-[10px]">{previewMode ? 'USDT' : casino.logo && (casino.logo.startsWith('/') || casino.logo.startsWith('http')) ? (
                                      <Image src={casino.logo} alt={casino.name} width={128} height={128} className="object-contain max-w-full max-h-full"  />
                                    ) : getLogoText()}</div>
                                              <span className="font-medium text-white">{previewMode ? (
                                      <span className="font-bold text-2xl sm:text-3xl tracking-tighter text-white">Tether</span>
                                    ) : casino.logo && (casino.logo.startsWith('/') || casino.logo.startsWith('http')) ? (
                                      <Image src={casino.logo} alt={casino.name} width={128} height={128} className="object-contain max-w-full max-h-full"  />
                                    ) : (
                                      <span className="font-bold text-2xl sm:text-3xl tracking-tighter text-white">{getLogoText()}</span>
                          ...
                          <div className="rounded-xl border border-white/5 bg-slate-900 p-6">
                              ...
                              <ul className="space-y-3">
                                  <li className="flex justify-between text-sm">
                                      <span className="text-slate-500">{previewMode ? (
                                      <span className="font-bold text-2xl sm:text-3xl tracking-tighter text-white">Established</span>
                                    ) : casino.logo && (casino.logo.startsWith('/') || casino.logo.startsWith('http')) ? (
                                      <Image src={casino.logo} alt={casino.name} width={128} height={128} className="object-contain max-w-full max-h-full"  />
                                    ) : (
                                      <span className="font-bold text-2xl sm:text-3xl tracking-tighter text-white">{getLogoText()}</span>
                          ...
                          <div>
                              ...
                              <div className="space-y-3">
                                  <a href="#" className="flex items-center gap-3 p-3 rounded-lg border border-white/5 hover:bg-white/5 transition-colors group">
                                      <div className="w-10 h-10 rounded bg-slate-800 flex items-center justify-center text-[10px] font-bold text-white group-hover:bg-slate-700">{previewMode ? 'ROYAL' : casino.logo && (casino.logo.startsWith('/') || casino.logo.startsWith('http')) ? (
                                      <Image src={casino.logo} alt={casino.name} width={128} height={128} className="object-contain max-w-full max-h-full"  />
                                    ) : getLogoText()}</div>
                                      <div>
                                  ...
                                  <a href="#" className="flex items-center gap-3 p-3 rounded-lg border border-white/5 hover:bg-white/5 transition-colors group">
                                      <div className="w-10 h-10 rounded bg-slate-800 flex items-center justify-center text-[10px] font-bold text-white group-hover:bg-slate-700">{previewMode ? 'ONYX' : casino.logo && (casino.logo.startsWith('/') || casino.logo.startsWith('http')) ? (
                                      <Image src={casino.logo} alt={casino.name} width={128} height={128} className="object-contain max-w-full max-h-full"  />
                                    ) : getLogoText()}</div>
                                      <div>
